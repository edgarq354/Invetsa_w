...
class Inspeccion_funcionamiento extends Conexion
{
	...
	public function preparar($observaciones,$frecuencia_de_uso,$id_servicio,$id_sqlite,$imei)
	{
		$this->id=0;
	...
	{
     $sql="insert into inspeccion_funcionamiento(observaciones,frecuencia_de_uso,id_servicio,id_sqlite,imei) values('$this->observaciones','$this->frecuencia_de_uso','$this->id_servicio','$this->id_sqlite','$this->imei')";
