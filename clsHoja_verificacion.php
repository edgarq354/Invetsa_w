...
class Hoja_verificacion extends Conexion
{
	...
	public function Hoja_Verificacion2($codigo,$firma_Empresa,$firma_Invetsa,$Hora_Ingreso,$Hora_Salida,$id,$id_Empresa,$id_Galpon,$id_Granja,$Productividad,$Promedio_Mantenimiento,$Puntaje_Control_Indice,$Revision,$sumatoria_Manipulacion_Vacuna,$imei)
	{
		parent::Conexion();
		$this->codigo=$codigo;
	...
	{
     $sql="insert into hoja_verificacion(codigo,firma_empresa,firma_invetsa,hora_ingreso,hora_salida,id,id_empresa,id_galpon,id_granja,productividad,promedio_mantenimiento,puntaje_control_indice,revision,sumatoria_manipulacion_vacuna,imei) values('$this->codigo','$this->firma_Empresa','$this->firma_Invetsa','$this->Hora_Ingreso','$this->Hora_Salida','$this->id','$this->id_Empresa','$this->id_Galpon','$this->id_Granja','$this->Productividad','$this->Promedio_Mantenimiento','$this->Puntaje_Control_Indice','$this->Revision','$this->sumatoria_Manipulacion_Vacuna','$this->imei')";
